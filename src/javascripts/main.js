  ...
  return (
    <VocabContext.Provider value={{vocabs, setVocabs, color, setColor}}>
      <Router>
        ...
        <Switch>
          <Route exact path="/vocab"><Vocab /></Route>
          <Route exact path="/vocab/:gid"><Group /></Route>
          <Route path="/vocab/:gid/word/:wid"><Word /></Route>
          <Redirect from="" to="/vocab"></Redirect>
        </Switch>
